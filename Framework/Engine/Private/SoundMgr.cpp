...
void CSoundMgr::Play_Sound_Loop(TCHAR * pSoundKey, CHANNELID eID, _float _vol)
{
	map<TCHAR*, FMOD_SOUND*>::iterator iter;
...
{
	_tfinddata64_t fd;
	__int64 handle = _tfindfirst64(L"../../Sound/SoundFiles/*.*", &fd);
	if (handle == -1 || handle == 0)
		return;

	int iResult = 0;

	char szCurPath[128] = "../../Sound/SoundFiles/";
	char szFullPath[128] = "";
