#include "stdafx.h"
#include "..\Public\JTrain_End.h"
#include "GameInstance.h"

CJTrain_End::CJTrain_End(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	: CLandObject(pDevice, pDeviceContext)

{
}

CJTrain_End::CJTrain_End(const CJTrain_End & rhs)
	: CLandObject(rhs)
{
}

HRESULT CJTrain_End::NativeConstruct_Prototype()
{
...
HRESULT CJTrain_End::NativeConstruct(void * pArg)
{
	if (FAILED(__super::NativeConstruct(&CTransform::TRANSFORMDESC(30.f, XMConvertToRadians(90.0f)))))
	{
		MSGBOX("Failed to CJTrain_End NativeConstruct");
		return E_FAIL;
	}

	if (FAILED(SetUp_Components()))
	{
		MSGBOX("Failed to CJTrain_End SetUp_Components");
		return E_FAIL;
	}
...
_int CJTrain_End::Tick(_double TimeDelta)
{
...
_int CJTrain_End::LateTick(_double TimeDelta)
{
...
HRESULT CJTrain_End::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_JTrain_End"),
...
HRESULT CJTrain_End::SetUp_ConstantTable()
{
...
CJTrain_End * CJTrain_End::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
{
	CJTrain_End*		pInstance = new CJTrain_End(pDevice, pDeviceContext);
...
CGameObject * CJTrain_End::Clone(void * pArg)
{
	CJTrain_End*	pInstance = new CJTrain_End(*this);
