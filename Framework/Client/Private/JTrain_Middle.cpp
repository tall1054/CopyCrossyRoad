#include "stdafx.h"
#include "..\Public\JTrain_Middle.h"
#include "GameInstance.h"

CJTrain_Middle::CJTrain_Middle(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	: CLandObject(pDevice, pDeviceContext)
{
}

CJTrain_Middle::CJTrain_Middle(const CJTrain_Middle & rhs)
	: CLandObject(rhs)
{
}

HRESULT CJTrain_Middle::NativeConstruct_Prototype()
{
...
HRESULT CJTrain_Middle::NativeConstruct(void * pArg)
{
...
_int CJTrain_Middle::Tick(_double TimeDelta)
{
...
_int CJTrain_Middle::LateTick(_double TimeDelta)
{
...
void CJTrain_Middle::Clear_Monster_Train()
{
...
HRESULT CJTrain_Middle::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_JTrain_Middle"),
...
HRESULT CJTrain_Middle::SetUp_ConstantTable()
{
...
CJTrain_Middle * CJTrain_Middle::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
{
	CJTrain_Middle*		pInstance = new CJTrain_Middle(pDevice, pDeviceContext);
...
CGameObject * CJTrain_Middle::Clone(void * pArg)
{
	CJTrain_Middle*	pInstance = new CJTrain_Middle(*this);
