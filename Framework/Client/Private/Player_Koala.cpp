#include "stdafx.h"
#include "..\Public\Player_Koala.h"
#include "GameInstance.h"

CPlayer_Koala::CPlayer_Koala(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	: CLandObject(pDevice, pDeviceContext)
{

}

CPlayer_Koala::CPlayer_Koala(const CPlayer_Koala & rhs)
	: CLandObject(rhs)
{
}

HRESULT CPlayer_Koala::NativeConstruct_Prototype()
{
	if (FAILED(__super::NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to CPlayer_Koala NativeConstruct_Prototype");
		return E_FAIL;
	}
...
HRESULT CPlayer_Koala::NativeConstruct(void * pArg)
{
	...
	CPlayer_Koala::Player_KoalaPosition	Player_Koalapos;
	ZeroMemory(&Player_Koalapos, sizeof(CPlayer_Koala::Player_KoalaPosition));
	Player_Koalapos.vPosition = _float4(25.f, 0.5f, 0.3f, 1.f);

	m_pTransform->Set_State(CTransform::STATE_POSITION, XMVectorSet(Player_Koalapos.vPosition.x, Player_Koalapos.vPosition.y, Player_Koalapos.vPosition.z, Player_Koalapos.vPosition.w));

	return S_OK;
}

_int CPlayer_Koala::Tick(_double TimeDelta)
{
...
_int CPlayer_Koala::LateTick(_double TimeDelta)
{
...
HRESULT CPlayer_Koala::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_Player_Koala"), TEXT("Com_Model"), (CComponent**)&m_pModelCom)))
		return E_FAIL;
...
HRESULT CPlayer_Koala::SetUp_ConstantTable()
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
...
HRESULT CPlayer_Koala::CollisionCheck()
{

	return S_OK;
}

CPlayer_Koala * CPlayer_Koala::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
{
	CPlayer_Koala*	pInstance = new CPlayer_Koala(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Created CPlayer_Koala");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CPlayer_Koala::Clone(void * pArg)
{
	CPlayer_Koala*	pInstance = new CPlayer_Koala(*this);
