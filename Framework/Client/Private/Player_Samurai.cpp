#include "stdafx.h"
#include "..\Public\Player_Samurai.h"
#include "GameInstance.h"

CPlayer_Samurai::CPlayer_Samurai(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	: CLandObject(pDevice, pDeviceContext)
{

}

CPlayer_Samurai::CPlayer_Samurai(const CPlayer_Samurai & rhs)
	: CLandObject(rhs)
{
}

HRESULT CPlayer_Samurai::NativeConstruct_Prototype()
{
	if (FAILED(__super::NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to CPlayer_Samurai NativeConstruct_Prototype");
		return E_FAIL;
	}
...
HRESULT CPlayer_Samurai::NativeConstruct(void * pArg)
{
	...
	CPlayer_Samurai::Player_SamuraiPosition	Player_Samuraipos;
	ZeroMemory(&Player_Samuraipos, sizeof(CPlayer_Samurai::Player_SamuraiPosition));
	Player_Samuraipos.vPosition = _float4(25.f, 0.5f, 0.3f, 1.f);

	m_pTransform->Set_State(CTransform::STATE_POSITION, XMVectorSet(Player_Samuraipos.vPosition.x, Player_Samuraipos.vPosition.y, Player_Samuraipos.vPosition.z, Player_Samuraipos.vPosition.w));

	return S_OK;
}

_int CPlayer_Samurai::Tick(_double TimeDelta)
{
...
_int CPlayer_Samurai::LateTick(_double TimeDelta)
{
...
HRESULT CPlayer_Samurai::Render()
{
...
HRESULT CPlayer_Samurai::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_Player_Samurai"), TEXT("Com_Model"), (CComponent**)&m_pModelCom)))
		return E_FAIL;
...
HRESULT CPlayer_Samurai::SetUp_ConstantTable()
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
...
HRESULT CPlayer_Samurai::CollisionCheck()
{

	return S_OK;
}

CPlayer_Samurai * CPlayer_Samurai::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
{
	CPlayer_Samurai*	pInstance = new CPlayer_Samurai(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Created CPlayer_Samurai");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CPlayer_Samurai::Clone(void * pArg)
{
	CPlayer_Samurai*	pInstance = new CPlayer_Samurai(*this);
