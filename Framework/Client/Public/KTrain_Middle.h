...
class CKTrain_Middle final : public CLandObject
{
public:
...
private:
	CKTrain_Middle(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	CKTrain_Middle(const CKTrain_Middle& rhs);
	virtual ~CKTrain_Middle() = default;
...
public:
	static CKTrain_Middle*	Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
