...
class CKoreaTruck002 final : public CLandObject
{
public:
	enum CARSTATE { STATE_NONE, STATE_IDLE, STATE_EXIT };
private:
	//생성자와 소멸자이며
	CKoreaTruck002(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	CKoreaTruck002(const CKoreaTruck002& rhs);
	virtual ~CKoreaTruck002() = default;
...
public:
	static CKoreaTruck002*	Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
