...
class CJapanCar001 final : public CLandObject
{
public:
	enum CARSTATE { STATE_NONE, STATE_IDLE, STATE_EXIT };
private:
	CJapanCar001(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	CJapanCar001(const CJapanCar001& rhs);
	virtual ~CJapanCar001() = default;
...
public:
	static CJapanCar001*	Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
