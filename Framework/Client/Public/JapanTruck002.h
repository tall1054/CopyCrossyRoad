...
class CJapanTruck002 final : public CLandObject
{
public:
	enum CARSTATE { STATE_NONE, STATE_IDLE, STATE_EXIT };
private:
	//생성자와 소멸자이며
	CJapanTruck002(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	CJapanTruck002(const CJapanTruck002& rhs);
	virtual ~CJapanTruck002() = default;
...
public:
	static CJapanTruck002*	Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
