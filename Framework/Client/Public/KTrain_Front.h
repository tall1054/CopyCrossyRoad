...
class CKTrain_Front final : public CLandObject
{
public:
...
private:
	CKTrain_Front(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	CKTrain_Front(const CKTrain_Front& rhs);
	virtual ~CKTrain_Front() = default;
...
public:
	static CKTrain_Front*	Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
