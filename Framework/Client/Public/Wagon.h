...
class CWagon final : public CLandObject
{
public:
	enum CARSTATE { STATE_NONE, STATE_IDLE, STATE_EXIT };
private:
	CWagon(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
	CWagon(const CWagon& rhs);
	virtual ~CWagon() = default;
...
public:
	static CWagon*	Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext);
